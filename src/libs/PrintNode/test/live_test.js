...
var API_KEY = "VgudRXLbfPQZiM23G4DZYvDrpPDdpXQ5A7zB-6Z7evs"; // <--- Change to your api key
var ACTIVE_PRINTER_ID = 71100335; // <--- Change to the id of the printer you want to use for testing. 
